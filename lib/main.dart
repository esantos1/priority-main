                    ...
                    Expanded(
                      ...
                      child: Center(
                        child: ValueListenableBuilder(
                          valueListenable: AlertMessenger.of(context).store,
                          builder: (context, _, __) => Text(
                            AlertMessenger.of(context).store.text,
                            style: TextStyle(
                                  ...
                                  onPressed: () {
                                    AlertMessenger.of(context).showAlert(
                                      alert: const Alert(
                                        ...
                                        child: Text(TextMessages.errorMessage),
                                      ),
                                    );
                                  },
                                  ...
                                  onPressed: () {
                                    AlertMessenger.of(context).showAlert(
                                      alert: const Alert(
                                        ...
                                        child:
                                            Text(TextMessages.warningMessage),
                                      ),
                                    );
                                  },
                                  style: const ButtonStyle(
                                  ...
                                  onPressed: () {
                                    AlertMessenger.of(context).showAlert(
                                      alert: const Alert(
                                        ...
                                        child: Text(TextMessages.infoMessage),
                                      ),
                                    );
                                  },
                                  style: const ButtonStyle(
